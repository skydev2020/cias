...
class User extends BaseController
{
    ...
    {
        $this->global['pageTitle'] = 'Swimmeetcast : Dashboard';
    ...
    function loginHistoy($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Swimmeetcast : User Login History';
    ...
    function profile($active = "details")
    {
        ...
        $this->global['pageTitle'] = $active == "details" ? 'Swimmeetcast : My Profile' : 'Swimmeetcast : Change Password';
